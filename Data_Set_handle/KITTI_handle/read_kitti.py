...
def get_bboxlist(rootpath,imagelist):
    cnt = 0
    wf_info = open("/home/user/PycharmProjects/Data_Set_handle/KITTI_handle/on_or_partial_occl_image_list.txt", "a+")
    ...
    for file_idx in imagelist:
        ...
        if os.path.exists(filename):
            ...
            for l in label_data:
                ...
                if data[0] in ['Pedestrian', 'Person_sitting', 'Cyclist']:
                    # todo 2018-10-21 22:02:58 筛选非严重遮挡查看
                    if data[2] in ['0', '1']:
