#--coding:utf-8--
import os
from unicoe_tool.generate_xml_upper_head import generate_xml
...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/caltech_new_anno/head_newtrain1x.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        if flag == 1:
            ...
            pass
        #test
        generate_xml("/home/user/PycharmProjects/caltech_new_anno/head_vis_0.6_6_4_upper_new1x/", fileInfo, obj)
        wf.write(fl.split('.')[0])
        wf.write('\n')
    print cnt
    #wf.write(cnt)
