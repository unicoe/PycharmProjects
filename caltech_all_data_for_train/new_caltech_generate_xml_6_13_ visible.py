...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/caltech_all_data_for_train/anno/6_20_anno_test_20/all_data_for_train.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        while contx:
            ...
            if contx:
                ...
                if tmpv[0] == "person":
                    ...
                    if tmpv[5] == '0' or (rate > 0.20 and rate <= 1):
                        tag = 1
                        cor_dict = {}
                        # 生成全身bbox
                        cor_dict["xmin"] = xmin
        ...
        #train
        if tag == 1:
            generate_xml("/home/user/PycharmProjects/caltech_all_data_for_train/anno/6_20_anno_test_20/annotations/", fileInfo,
                         obj)
            wf.write(fl.split('.')[0])
            wf.write('\n')
            tag = 0
            pass
        #test
        # generate_xml("/home/user/PycharmProjects/caltech_all_data_for_train/anno/6_20_anno/annotations/", fileInfo, obj)
        # wf.write(fl.split('.')[0])
        # wf.write('\n')
    print cnt
    #wf.write(cnt)
...
folder_struct(1, "/home/user/Downloads/caltech_data_set/datasets/caltech_all_train/train/annotations")
