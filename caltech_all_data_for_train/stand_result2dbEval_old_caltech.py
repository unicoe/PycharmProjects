...
readfile = open("/home/user/PycharmProjects/caltech_new_anno/0.33.txt")
...
while contx:
    ...
    mkdir("/home/user/PycharmProjects/caltech_new_anno/0.33/" + pathls[0])
    wf = open("/home/user/PycharmProjects/caltech_new_anno/0.33/" + pathls[0] +"/"+pathls[1]+".txt","aw")
