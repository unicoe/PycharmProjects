...
def get_im_ls():
    ...
    im_ls_r = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/PascalVOC-Dataset/SegmentationClass/lst/new10x_gt_info_20_zss_vis_img_list.txt","r")
    im_ls = []
...
def get_gt_info():
    gt_r = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/PascalVOC-Dataset/SegmentationClass/lst/new10x_gt_info_20_zss_vis.txt", "r")
    gt_dict = {}
...
for i_im in im_ls:
    ...
    if i_im in gt_dict:
        ...
        mkdir("/home/user/Disk1.8T/data_set/seglabel_png_8_7_visible/")
        img.save("/home/user/Disk1.8T/data_set/seglabel_png_8_7_visible/" + i_im + ".png", 'png')