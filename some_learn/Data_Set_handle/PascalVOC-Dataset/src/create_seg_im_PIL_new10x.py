...
def get_im_ls():
    ...
    im_ls_r = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/PascalVOC-Dataset/SegmentationClass/lst/new10x_caltech_person_5_10_vis0.3_h20_w10.txt","r")
    im_ls = []
...
def get_gt_info():
    gt_r = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/PascalVOC-Dataset/SegmentationClass/lst/new10x_gt_info_20_10_0.3_zss.txt", "r")
    gt_dict = {}
...
for i_im in im_ls:
    ...
    if i_im in gt_dict:
        ...
        mkdir("/home/user/Disk1.8T/data_set/seglabel_png_5_10_new10x/")
        img.save("/home/user/Disk1.8T/data_set/seglabel_png_5_10_new10x/" + i_im + ".png", 'png')