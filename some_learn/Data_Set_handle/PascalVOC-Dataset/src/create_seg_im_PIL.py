...
for i_im in im_ls:
    ...
    if i_im in gt_dict:
        ...
        for i_bbox in gt_dict[i_im]:
            ...
            draw2.rectangle((tmp[0]-1,tmp[1]-1, tmp[2]+1,tmp[3]+1), fill=(224, 224, 192))
            draw2.rectangle((tmp[0]+1, tmp[1]+1, tmp[2]-1, tmp[3]-1), fill=(128,0,0))
            # img = img[:,:,(2,1,0)]
            # debug 2018-12-06 22:12:56
            # plt.imshow(img)
            # plt.show()
        # cv2.imwrite("/home/user/Disk1.8T/data_set/seglabel_png1/" + i_im + ".png", img)
        mkdir("/home/user/Disk1.8T/data_set/seglabel_png_12_8/")
        img.save("/home/user/Disk1.8T/data_set/seglabel_png_12_8/" + i_im + ".png", 'png')