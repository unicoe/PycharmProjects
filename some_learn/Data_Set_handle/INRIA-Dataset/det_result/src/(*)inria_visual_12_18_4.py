    ...
    for idx_im in dirList:
        ...
        if inDict_name in tmp_dict :
            ...
            if flag == 1:
                ...
                mkdir('/home/user/Disk1.8T/draw_result/paper_result/inria_cv_adapt/' + folder_name + '/' + str(inDict[-3] + '/' + inDict[-2]))
                cv2.imwrite('/home/user/Disk1.8T/draw_result/paper_result/inria_cv_adapt/' + folder_name + '/' +
...
'/home/user/PycharmProjects/some_learn/Data_Set_handle/INRIA-Dataset/det_result/det/adapt-inria.txt'
