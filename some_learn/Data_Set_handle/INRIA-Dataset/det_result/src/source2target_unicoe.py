...
rf = open("/home/unicoe/experiements/11_15/INRIA-Dataset/lst/test_img_shape.txt", "r")
...
rf1 = open("/home/unicoe/experiements/11_15/INRIA-Dataset/det_result/det/2018_11_15_Thu_07_48_54_det_test_person.txt", "r")
...
for im_idx in im_name_lst:
    if im_idx in det_dict:
        ...
        """
        im_scale = float(768) / float(min_size)
        # Prevent the biggest axis from being more than MAX_SIZE
        if np.round(im_scale * max_size) > 1536:
            im_scale = float(1536) / float(max_size)
...
wf = open("/home/unicoe/experiements/11_15/INRIA-Dataset/det_result/det/handle_2018_11_15_Thu_07_48_54_det_test_person.txt", "w")
