    ...
    for idx_im in dirList:
        ...
        if inDict_name in tmp_dict :
            ...
            if flag == 1:
                ...
                mkdir('/home/user/Disk1.8T/draw_result/paper_result/eth_cv_adapt/' + folder_name + '/' + str(inDict[-3] + '/' + inDict[-2]))
                cv2.imwrite('/home/user/Disk1.8T/draw_result/paper_result/eth_cv_adapt/' + folder_name + '/' +
