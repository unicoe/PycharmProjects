...
ls_a = [
# ours
'/home/user/Disk1.8T/draw_result/paper_result/eth_cv/PAMS-FCN-eth/user/',
...
ls_b = [
# adapt
'/home/user/Disk1.8T/draw_result/paper_result/eth_cv_adapt/adapt-eth/user/',
...
for sp in splits:
    for i_a in ls_a:
        for i_b in ls_b:
            ...
            img_fold_AB_tmp = img_fold_B #.split('images_ETH/')
            img_fold_AB = os.path.join(img_fold_AB_tmp,'images_ETH', 'combime')
