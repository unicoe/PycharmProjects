...
def draw_bbox(file_idx, tmp_dict):
    ...
    tgt_r = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/INRIA-Dataset/det_result/src/selected_ls/eth_ls.txt", "r")
    tg_ls = []
    ...
    for idx_im in dirList:
        ...
        if inDict_name in tmp_dict and inDict_name in tg_ls:
            ...
            if flag == 1:
                ...
                mkdir('/home/user/Disk1.8T/draw_result/paper_result/eth2/' + folder_name + '/' + str(inDict[-3] + '/' + inDict[-2]))
                # cv2.imwrite('/home/user/Disk1.8T/draw_result/paper_result/submit/' + folder_name + '/' +
                #             str(inDict[-3] + '/' + inDict[-2]) + '/' + bot + ".jpg",
                #             im)
                plt.savefig('/home/user/Disk1.8T/draw_result/paper_result/eth2/' + folder_name + '/' +
...
file_lst = [
'/home/user/PycharmProjects/some_learn/Data_Set_handle/INRIA-Dataset/det_result/det/adapt-eth.txt',
'/home/user/PycharmProjects/some_learn/Data_Set_handle/INRIA-Dataset/det_result/det/PAMS-FCN-eth.txt'
