...
ls_a = [
# ours
'/home/user/Disk1.8T/draw_result/paper_result/inria_cv/PAMS-FCN-inria/VOC0712/',
...
ls_b = [
# adapt
'/home/user/Disk1.8T/draw_result/paper_result/inria_cv_adapt/adapt-inria/VOC0712/',
...
for sp in splits:
    for i_a in ls_a:
        for i_b in ls_b:
            ...
            img_fold_AB = os.path.join(img_fold_AB_tmp,'JPEGImages', 'combime')
