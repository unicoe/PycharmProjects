...
def draw_bbox(tmp_dict):
    ...
    for idx_im in dirList:
        ...
        if inDict_name in tmp_dict :
            ...
            if flag == 1:
                img_cnt = img_cnt + 1
                mkdir('/home/user/Disk1.8T/draw_result/kitti/test_11_22_Thu_10_05_53/' + str(inDict[-3] + '/' + inDict[-2]))
                cv2.imwrite('/home/user/Disk1.8T/draw_result/kitti/test_11_22_Thu_10_05_53/' +
    ...
    #print str(undet_img)
    w_undet = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/KITTI-Dataset/src/visual_test/un_det_test_11_22_Thu_10_05_53.txt", "w")
...
file_path = "/home/user/Disk1.8T/KITTI-experiments/det_result/11_23/66_psroi_testing/2018_11_22_Thu_10_05_53_det_test_person.txt"
