...
def draw_bbox(tmp_dict):
    ...
    for idx_im in dirList:
        ...
        if inDict_name in tmp_dict :
            ...
            if flag == 1:
                img_cnt = img_cnt + 1
                mkdir('/home/user/Disk1.8T/draw_result/kitti/handle_2018_11_25_Sun_08_08_07_det_test_person_nms_55/' + str(inDict[-3] + '/' + inDict[-2]))
                cv2.imwrite('/home/user/Disk1.8T/draw_result/kitti/handle_2018_11_25_Sun_08_08_07_det_test_person_nms_55/' +
    ...
    #print str(undet_img)
    w_undet = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/KITTI-Dataset/src/visual_test/handle_2018_11_25_Sun_08_08_07_det_test_person_nms_55.txt", "w")
...
file_path = '/home/user/PycharmProjects/some_learn/Data_Set_handle/KITTI-Dataset/src/im_scale_handle/handle_2018_11_25_Sun_08_08_07_det_test_person_nms_55.txt'
