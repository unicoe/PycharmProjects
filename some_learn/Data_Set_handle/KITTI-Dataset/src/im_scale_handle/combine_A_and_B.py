...
parser.add_argument('--fold_A',
                    ...
                    type=str,
                    default='/home/user/Disk1.8T/draw_result/6_15/handle_6_15_det_test_head')

parser.add_argument('--fold_B',
                    dest='fold_B',
                    help='input directory for image B',
                    type=str,
                    default='/home/user/Disk1.8T/draw_result/6_15/6_20_nms_det_test_person/')

parser.add_argument('--fold_AB',
                    dest='fold_AB',
                    help='output directory',
                    type=str,
                    default='/home/user/Disk1.8T/draw_result/6_15/combine_bestresult_head/')
