...
import cv2
im = cv2.imread("/home/user/PycharmProjects/some_learn/Data_Set_handle/KITTI-Dataset/src/visual_bbox_single_img/002837.png")
...
cv2.rectangle(im, (0,154), (64, 357), (0,255,0), 1)

#cv2.rectangle(im, (430,100), (455, 160), (0,255,0), 1)   # test -> 25*60   60/25=2.4
