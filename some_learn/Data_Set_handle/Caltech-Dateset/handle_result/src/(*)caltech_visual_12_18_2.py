            ...
            for idx_bbox in bboxList:
                ...
                if float(idx_bbox[0]) >= 0.5:
                    ...
                    ax.text(x1, y1 - 7,
                            ...
                            fontsize=8,weight="normal" ,color='black')
...
'/home/user/PycharmProjects/some_learn/Data_Set_handle/Caltech-Dateset/handle_result/det_result/3_16/1/2019_03_16_Sat_00_06_08.txt',
