#--coding:utf-8--
import os
from unicoe_tool.generate_upper_xml import generate_xml
...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/caltech_new_anno/upper_vis_0.65_6_24_upper_new1x.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        if flag == 1:
            ...
            pass
        #test
        generate_xml("/home/user/PycharmProjects/caltech_new_anno/upper_vis_0.65_6_24_upper_new1x/", fileInfo, obj)
        wf.write(fl.split('.')[0])
        wf.write('\n')
    print cnt
    #wf.write(cnt)
