...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/caltech_new_anno/head_full_newtrain1x_vis_0.35.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        if flag == 1:
            ...
            pass
        #test
        generate_xml("/home/user/PycharmProjects/caltech_new_anno/head_vis_0.35_7_1_head_full_new1x/", fileInfo, obj)
        wf.write(fl.split('.')[0])
        wf.write('\n')
    print cnt
    #wf.write(cnt)
