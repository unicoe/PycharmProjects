            ...
            if contx:
                ...
                if tmpv[0] == "person":
                    ...
                    if tmpv[5] == '0' or tmpv[5] == '1':
                        ...
                        cv2.rectangle(im, (int(xmin), int(ymin)), (int(xmax), int(ymax)), (225, 0, 0), 3)

                        if tmpv[5] == '1':
                            cv2.rectangle(im, (int(v_xmin), int(v_ymin)), (int(v_xmax), int(v_ymax)), (0, 0, 255), 2)
