...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/caltech_new_anno/old_train1x_12_30_1x_0.3_20_10.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        #test
        if len(obj) != 0:
            generate_xml("/home/user/PycharmProjects/caltech_new_anno/old_train1x_12_30_1x_0.3_20_10/", fileInfo, obj)
            wf.write(fl.split('.')[0])
            wf.write('\n')
    print cnt
    pass
