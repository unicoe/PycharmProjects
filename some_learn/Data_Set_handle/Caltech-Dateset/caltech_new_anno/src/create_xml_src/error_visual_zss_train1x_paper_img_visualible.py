...
def folder_struct(level, path):
    ...
    for fl in fileList:
        ...
        while contx:
            ...
            if contx:
                ...
                if tmpv[0] == "person":
                    ...
                    if tmpv[5] == '1':
                        ...
                        mkdir('/home/user/Disk1.8T/draw_train_and_test/anno_img_visual/')
                        plt.savefig(
                            '/home/user/Disk1.8T/draw_train_and_test/anno_img_visual/' + str(fl.split('.')[0] + '.png'))
                        obj.append(cor_dict)
            ...
            #
            #             mkdir('/home/user/Disk1.8T/draw_train_and_test/anno_img_visual/')
            #             plt.savefig('/home/user/Disk1.8T/draw_train_and_test/anno_img_visual/' + str(fl.split('.')[0]+'.png'))
            #             obj.append(cor_dict)
            #             rate = 0
            #
            # else:
