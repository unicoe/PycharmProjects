...
def folder_struct(level, path):
    ...
    # print dirList
    cnt = 0
    wf = open("/home/user/PycharmProjects/some_learn/Data_Set_handle/Caltech-Dateset/caltech_new_anno/annotations/old1x_caltech_person_5_10_vis0.3_h20_w10.txt", "w")
    print len(fileList)
    for fl in fileList:
        ...
        #test
        if len(obj) != 0:
            generate_xml("/home/user/PycharmProjects/some_learn/Data_Set_handle/Caltech-Dateset/caltech_new_anno/annotations/old1x_caltech_person_5_10_vis0.3_h20_w10/", fileInfo, obj)
            wf.write(fl.split('.')[0])
            wf.write('\n')
    print cnt
    #wf.write(cnt)
