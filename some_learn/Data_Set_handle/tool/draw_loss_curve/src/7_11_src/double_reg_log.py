...
rf = open("/home/user/PycharmProjects/draw_loss_curve/logs/rfcn_end2end_ResNet-50_.txt.2018-07-11_10-50-44")
...
mkdir("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/")
al_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_all_loss.txt", "w")
ac_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_accuarcy.txt", "w")
bl_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_loss_bbox.txt", "w")
cl_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_loss_cls.txt", "w")
rcl_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_rpn_cls_loss.txt", "w")
rbl_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_rpn_loss_bbox.txt", "w")
ac_head_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_head_accuarcy.txt", "w")
bl_head_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_head_loss_bbox.txt", "w")
cl_head_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_head_loss_cls.txt", "w")
rcl_head_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_head_rpn_cls_loss.txt", "w")
rbl_head_wf = open("/home/user/PycharmProjects/draw_loss_curve/logs/7_11/train_head_rpn_loss_bbox.txt", "w")
