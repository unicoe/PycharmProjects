...
file_path = "/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/rfcn_end2end_ResNet-50_.txt.2018-10-13_21-58-32"
...
mkdir("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/")
al_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_all_loss_res5c.txt", "w")
ac_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_accuarcy_res5c.txt", "w")
bl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_bbox_res5c.txt", "w")
cl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_cls_res5c.txt", "w")
rcl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_cls_loss_res5c.txt", "w")
rbl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_loss_bbox_res5c.txt", "w")
...
mkdir("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/")
al_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_all_loss_p3.txt", "w")
ac_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_accuarcy_p3.txt", "w")
bl_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_bbox_p3.txt", "w")
cl_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_cls_p3.txt", "w")
rcl_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_cls_loss_p3.txt", "w")
rbl_wf_p3 = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_loss_bbox_p3.txt", "w")
