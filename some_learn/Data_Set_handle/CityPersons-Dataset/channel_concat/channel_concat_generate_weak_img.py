...
org_img_path = "/home/user/Disk1.8T/data_set/cityspaces/leftImg8bit/val"
# /aachen/aachen_000000_000019_leftImg8bit.png

label_img_path = "/home/user/Disk1.8T/data_set/city_seglabel_png_5_6"
...
for city_name in org_img_folder:
    ...
    for it in img_ls:
        ...
        save_folder = "/home/user/Disk1.8T/data_set/cityspaces/weak_concat_channel/val/" + city_name
        mkdir(save_folder)
