...
namespace caffe {
  ...
  __global__ void PSROIPoolingForward(
    ...
    if (divide_type == 0)
    {
          ...
          int part_arr[] = {0,6,18,38};   //6 12 20 28
    ...
    else if(divide_type == 1)
    {
          ...
          int part_arr[] = {0,4,10,19};   //6 12 20 28

          if(index_mod >= 0 && index_mod < 4){
                order = 0;

          }else if(index_mod >= 4 && index_mod < 10){
                order = 1;

          }else if(index_mod >= 10 && index_mod < 19){
                order = 2;

          }else if(index_mod >= 19 && index_mod < 34){
                order = 3;
