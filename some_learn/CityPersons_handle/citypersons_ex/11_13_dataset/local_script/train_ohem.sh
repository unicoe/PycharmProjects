...
LOG="experiments/11_13_dataset/logs/train_rfcn_end2end_${NET}_${EXTRA_ARGS_SLUG}.txt.`date +'%Y-%m-%d_%H-%M-%S'`"
exec &> >(tee -a "$LOG")
echo Logging output to "$LOG"


time ./tools/train_net.py --gpu ${GPU_ID} \
  --solver experiments/11_13_dataset/local_script/solver_ohem.prototxt \
...
time ./tools/test_net.py --gpu ${GPU_ID} \
 --def experiments/11_13_dataset/model_ohem/multi_test.prototxt \
  --net output/11_13_dataset/model/voc_0712_trainval/fpn_rfcn_ohem_iter_4000.caffemodel \
  --imdb ${TEST_IMDB} \
  --cfg experiments/11_13_dataset/rfcn_end2end_ohem.yml \
  --set TEST.SOFT_NMS 0
  ${EXTRA_ARGS}
...
time ./tools/test_net.py --gpu ${GPU_ID} \
  --def experiments/11_13_dataset/model_ohem/multi_test.prototxt \
  --net output/11_13_dataset/model/voc_0712_trainval/fpn_rfcn_ohem_iter_3000.caffemodel \
  --imdb ${TEST_IMDB} \
  --cfg experiments/11_13_dataset/rfcn_end2end_ohem.yml \
  --set TEST.SOFT_NMS 0
  ${EXTRA_ARGS}
...
time ./tools/test_net.py --gpu ${GPU_ID} \
  --def experiments/11_13_dataset/model_ohem/multi_test.prototxt \
  --net output/11_13_dataset/model/voc_0712_trainval/fpn_rfcn_ohem_iter_2000.caffemodel \
  --imdb ${TEST_IMDB} \
  --cfg experiments/11_13_dataset/rfcn_end2end_ohem.yml \
  --set TEST.SOFT_NMS 0
  ${EXTRA_ARGS}