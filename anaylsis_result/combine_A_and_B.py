...
parser.add_argument('--fold_A', dest='fold_A', help='input directory for image A', type=str, default='/home/user/draw_result/6_15/6_15_det_test_person/')
...
parser.add_argument('--fold_AB', dest='fold_AB', help='output directory', type=str, default='/home/user/draw_result/6_15/combine')
