...
#loda data
train_all_loss_res5c = loadData_all_loss('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_all_loss_res5c.txt')
train_accuracy_res5c = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_accuarcy_res5c.txt')
train_loss_bbox_res5c = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_bbox_res5c.txt')
train_loss_cls_res5c = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_cls_res5c.txt')
train_rpn_cls_loss_res5c = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_cls_loss_res5c.txt')
train_rpn_loss_bbox_res5c = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_loss_bbox_res5c.txt')
...
plt.savefig("/home/user/PycharmProjects/draw_loss_curve/img/10_15_py_log1_res5c.png")
...
train_all_loss_p3 = loadData_all_loss('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_all_loss_p3.txt')
train_accuracy_p3 = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_accuarcy_p3.txt')
train_loss_bbox_p3 = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_bbox_p3.txt')
train_loss_cls_p3 = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_loss_cls_p3.txt')
train_rpn_cls_loss_p3 = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_cls_loss_p3.txt')
train_rpn_loss_bbox_p3 = loadData('/home/user/PycharmProjects/draw_loss_curve/logs/10_15_py_log/train_rpn_loss_bbox_p3.txt')
...
plt.savefig("/home/user/PycharmProjects/draw_loss_curve/img/10_15_py_log1_p3.png")
#save format maybe : format="eps"  or "pdf"
