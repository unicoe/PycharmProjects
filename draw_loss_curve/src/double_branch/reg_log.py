...
file_path = "/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_rfcn_end2end_ResNet-50_.txt.2018-10-15_07-30-06"
rf = open(file_path)
...
mkdir("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/")
al_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_all_loss_res5c.txt", "w")
ac_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_accuarcy_res5c.txt", "w")
bl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_loss_bbox_res5c.txt", "w")
cl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_loss_cls_res5c.txt", "w")
rcl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_rpn_cls_loss_res5c.txt", "w")
rbl_wf_res5c = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_rpn_loss_bbox_res5c.txt", "w")
...
mkdir("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/")
al_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_all_loss_res3d.txt", "w")
ac_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_accuarcy_res3d.txt", "w")
bl_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_loss_bbox_res3d.txt", "w")
cl_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_loss_cls_res3d.txt", "w")
rcl_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_rpn_cls_loss_res3d.txt", "w")
rbl_wf_res3d = open("/home/user/PycharmProjects/draw_loss_curve/logs/10_16/train_rpn_loss_bbox_res3d.txt", "w")
