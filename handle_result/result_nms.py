...
rf = open("/home/user/PycharmProjects/handle_result/result_detection/7_7_det_test_person.txt")
...
wf = open("/home/user/PycharmProjects/handle_result/result_detection/nms_7_7_det_test_person.txt", "w")
...
for key in result_dir.iterkeys():
    ...
    nms_res = nms_area.py_cpu_nms(tmp_np1, 0.4)
