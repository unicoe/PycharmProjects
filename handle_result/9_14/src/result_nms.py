...
rf = open("/home/user/PycharmProjects/handle_result/9_14/result/merge2_det_test_person_and_head.txt")
...
wf = open("/home/user/PycharmProjects/handle_result/9_14/result/nms_merge2_det_test_person_and_head.txt", "w")
