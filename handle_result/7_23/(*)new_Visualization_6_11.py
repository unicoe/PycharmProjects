...
def show_IOU_gt_and_result(gt_dict, res_dict):
    ...
    for dir_ in dirList:
        if dir_ in gt_dict and dir_ in res_dict:
            ...
            mkdir('/home/user/Disk1.8T/draw_result/7_23/comp4_0cbc6d1c-7398-4902-b9a0-972785e1c6c4_det_test_head/test/')
            cv2.imwrite('/home/user/Disk1.8T/draw_result/7_23/comp4_0cbc6d1c-7398-4902-b9a0-972785e1c6c4_det_test_head/test/' + str(dir_ + ".jpg"),
                        im)

gt_dict = generate_gt_dict("/home/user/PycharmProjects/anaylsis_result/draw_result_in_new_anno/gt_file/test_gt.txt")
res_dict = generate_result("/home/user/PycharmProjects/handle_result/7_23/comp4_0cbc6d1c-7398-4902-b9a0-972785e1c6c4_det_test_head.txt")
