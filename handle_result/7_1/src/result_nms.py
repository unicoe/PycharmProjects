...
rf = open("/home/user/PycharmProjects/handle_result/7_1/result/7_1_det_test_person.txt")
...
wf = open("/home/user/PycharmProjects/handle_result/7_1/result/nms_7_1_det_test_person.txt", "w")
