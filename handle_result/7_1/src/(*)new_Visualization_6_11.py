...
def show_IOU_gt_and_result(gt_dict, res_dict):
    ...
    for dir_ in dirList:
        if dir_ in gt_dict and dir_ in res_dict:
            ...
            mkdir('/home/user/Disk1.8T/draw_result/6_25/nms_handle_merge_result/test/')
            cv2.imwrite('/home/user/Disk1.8T/draw_result/6_25/nms_handle_merge_result/test/' + str(dir_ + ".jpg"),
                        im)

gt_dict = generate_gt_dict("/home/user/PycharmProjects/anaylsis_result/draw_result_in_new_anno/gt_file/test_gt.txt")
res_dict = generate_result("/home/user/PycharmProjects/handle_result/6_25/handle_result/nms_handle_merge_result.txt")
