...
def show_IOU_gt_and_result(gt_dict, res_dict):
    ...
    for dir_ in dirList:
        if dir_ in gt_dict and dir_ in res_dict:
            ...
            for idx_gt in gtList:
                ...
                for idx_detail in idx_gt:
                    ...
                    for idx_res in resList:
                        ...
                        cv2.putText(im, str(str(iou_res) + " " + str(idx_res[0])), (int(res_x1), int(res_y1 - 6)),
            ...
            mkdir('/home/user/Disk1.8T/draw_result/9_26/result/2018_09_28_Fri_20_33_21_det_test_person/test/')
            cv2.imwrite('/home/user/Disk1.8T/draw_result/9_26/result/2018_09_28_Fri_20_33_21_det_test_person/test/' + str(dir_ + ".jpg"),
                        im)

gt_dict = generate_gt_dict("/home/user/PycharmProjects/anaylsis_result/draw_result_in_new_anno/gt_file/test_gt.txt")
res_dict = generate_result("/home/user/PycharmProjects/handle_result/9_26/result/2018_09_28_Fri_20_33_21_det_test_person.txt")
